...
export default function AlumnosFilters({
  ...
  return (
  <div className="bg-white/90 backdrop-blur-sm p-4 rounded-2xl border border-gray-200 shadow-sm flex flex-col xl:flex-row gap-4 xl:items-center xl:justify-between relative z-20" role="region" aria-label="Filtros de alumnos" aria-describedby="alumnos-filtros-descripcion">
      {/* Búsqueda + filtros agrupados */}
      <div className="flex flex-col md:flex-row gap-4 flex-1 items-stretch md:items-center flex-wrap">
        {/* Input búsqueda */}
        <div className="group flex items-center gap-2 px-3 h-10 rounded-full border border-gray-200 bg-gradient-to-b from-white to-gray-50 shadow-sm focus-within:ring-2 focus-within:ring-yellow-300 focus-within:border-yellow-300 transition" role="search">
      ...
      <div className="flex items-center gap-3 text-xs text-gray-500" id="alumnos-filtros-descripcion" aria-live="polite">
