...
export default function PersonalFilters({ value, onChange }) {
  const [q, setQ] = useState(value || '');
  useEffect(()=>{ setQ(value||''); }, [value]);
  return (
    <div className="card-90 backdrop-blur-sm p-4 rounded-2xl border shadow-sm flex flex-col gap-4 relative" role="search" aria-label="Filtros de personal">
